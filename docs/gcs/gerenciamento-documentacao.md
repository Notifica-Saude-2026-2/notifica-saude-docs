...
??? danger "OLD — conteúdo anterior desta página (mantido apenas para validação)"
    ...
    **OLD — 2. Padronização de nomenclatura**
    ...
    **OLD — 3. Versionamento dos documentos**
    ...
    **OLD — 5. Estrutura dos documentos**
    ...
    **OLD — 6. Atualização e manutenção**
